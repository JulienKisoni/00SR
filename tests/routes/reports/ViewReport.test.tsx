...
import ViewReport from "../../../src/routes/reports/ViewReport";
...
describe("View Report Details Feature", () => {
  afterEach(() => {
    cleanup();
  });
  describe("User can view more details about a report", () => {
    let state: RootState;
    beforeEach(() => {
    ...
    test("should work", async () => {
      await act(async () => {
        renderWithProviders(<ViewReport />, { preloadedState: state });
      });
  ...
  describe("User cannot view more details about a report", () => {
    ...
    test("should redirect to NotFound", async () => {
      await act(async () => {
        renderWithProviders(<ViewReport />, {
